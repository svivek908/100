      ...
      if ($res) {
       // echo "hi";exit;
        redirect("http://localhost/100/index.php/admin/full");
         ...
         redirect("http://localhost/100/index.php/admin/redirect");
 }
        }
...
$this->load->model("mmhselect");
       $querry=$this->session->sess_destroy($data);
       //print_r ($querry);
redirect("http://localhost/100/index.php/admin/index");
        }
